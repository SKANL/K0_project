...
function requireVault(vault: ProtectedVaultPort | undefined): ProtectedVaultPort { if (!vault || typeof vault.get !== "function") throw new Error("PROTECTED_VAULT_REQUIRED"); return vault; }
...
export function createAppleAdapter(host: AppleHost): IntegrationProviderPort {
  ...
  const adapter: IntegrationProviderPort = {
    ...
    capability: integrationCapability("apple", ["notes", "shortcuts"], { maxRequestsPerMinute: 30, maxPayloadChars: 16_384 }),
